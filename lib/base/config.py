...
HYSTERIA_CLIENT_TEMPLATE_CONFIG_FILE = f"{RAINB0W_HOME_DIR}/hysteria/etc/client.json"
...
MTPROTOPY_DOCKER_COMPOSE_FILE = f"{RAINB0W_HOME_DIR}/mtprotopy/docker-compose.yml"
