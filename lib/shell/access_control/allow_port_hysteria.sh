...
iptables -I INPUT $LINENUM -p udp --dport 8443 -m conntrack --ctstate NEW -m comment --comment "Allow Hysteria" -j ACCEPT
ip6tables -I INPUT $LINENUM -p udp --dport 8443 -m conntrack --ctstate NEW -m comment --comment "Allow Hysteria" -j ACCEPT
